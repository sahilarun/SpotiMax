...
import 'package:spotimax/features/presentation/settings/widgets/setting_with_text_field.dart';
...
import 'package:spotimax/features/data/api/api.dart';
...
class _AuthSettingsState extends State<AuthSettings> {
  ...
  Future<void> _launchSpotifyAuthorization() async {
    await launchUrl(
      Uri.parse(
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      child: BlocListener<ClientAuthBloc, ClientAuthState>(
        ...
        child: SettingsGroup(
          header: S.of(context).spotifySDKAndAccount,
          settings: [
                    ...
                    children: [
                      ...
                      Builder(builder: (context) {
                        ...
                        if (state is AccountAuthAuthorized || state is AccountAuthNetworkFailure) {
                          ...
                          onButtonClicked = _launchSpotifyAuthorization;
                        }
