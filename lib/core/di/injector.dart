...
import 'package:spotimax/core/db/local_db.dart';
import 'package:spotimax/core/db/local_db_impl.dart';
...
import 'package:spotimax/features/data/auth/local_auth/repository/local_auth_repository_impl.dart';
import 'package:spotimax/features/data/auth/network_auth/data_source/network_auth_data_source.dart';
import 'package:spotimax/features/data/auth/network_auth/repository/network_auth_repository_impl.dart';
import 'package:spotimax/features/data/settings/data_source/settings_data_source.dart';
import 'package:spotimax/features/data/settings/repository/settings_repository_impl.dart';
import 'package:spotimax/features/data/spotify_profile/data_source/spotify_profile_data_source.dart';
import 'package:spotimax/features/data/spotify_profile/repository/spotify_profile_repository_impl.dart';
import 'package:spotimax/features/data/tracks/local_tracks/data_sources/local_tracks_data_source.dart';
import 'package:spotimax/features/data/tracks/local_tracks/repositories/local_tracks_repository_impl.dart';
import 'package:spotimax/features/data/tracks_collections/history_tracks_collectons/data_source/tracks_collectons_history_data_source.dart';
import 'package:spotimax/features/data/tracks_collections/history_tracks_collectons/repositories/tracks_collections_history_repository_impl.dart';
import 'package:spotimax/features/data/tracks/dowload_tracks/data_sources/dowload_audio_from_youtube_data_source.dart';
import 'package:spotimax/features/data/tracks/dowload_tracks/data_sources/tools/audio_metadata_editor/audio_metadata_editor_impl.dart';
import 'package:spotimax/features/data/tracks/dowload_tracks/data_sources/tools/file_to_mp3_converter/ffmpeg_file_to_mp3_converter.dart';
import 'package:spotimax/features/data/tracks/dowload_tracks/repositories/dowload_tracks_repository_impl.dart';
import 'package:spotimax/features/data/tracks/network_tracks/data_sources/network_tracks_data_source.dart';
import 'package:spotimax/features/data/tracks/network_tracks/repositories/network_tracks_repository_impl.dart';
import 'package:spotimax/features/data/tracks/search_videos_by_track/data_sources/search_video_on_youtube_data_source.dart';
import 'package:spotimax/features/data/tracks/search_videos_by_track/repositories/search_videos_by_track_repository_impl.dart';
import 'package:spotimax/features/data/tracks_collections/network_tracks_collections/data_source/network_tracks_collections_data_source.dart';
import 'package:spotimax/features/data/tracks_collections/network_tracks_collections/repositories/tracks_collections_repository_impl.dart';
...
import 'package:spotimax/features/domain/auth/local_auth/use_cases/clear_user_credentials.dart';
import 'package:spotimax/features/domain/auth/local_auth/use_cases/get_client_credentials.dart';
import 'package:spotimax/features/domain/auth/local_auth/use_cases/save_client_credentials.dart';
import 'package:spotimax/features/domain/auth/network_auth/repository/network_auth_repository.dart';
import 'package:spotimax/features/domain/auth/service/service/auth_service.dart';
import 'package:spotimax/features/domain/auth/service/service/auth_service_impl.dart';
import 'package:spotimax/features/domain/auth/service/use_cases/authorize_user.dart';
...
import 'package:spotimax/features/domain/spotify_profile/repository/spotify_profile_repostitory.dart';
import 'package:spotimax/features/domain/spotify_profile/service/spotify_profile_service.dart';
import 'package:spotimax/features/domain/spotify_profile/service/spotify_profile_service_impl.dart';
import 'package:spotimax/features/domain/spotify_profile/use_cases/get_spotify_profile.dart';
import 'package:spotimax/features/domain/tracks/local_tracks/repositories/local_tracks_repository.dart';
import 'package:spotimax/features/domain/tracks/observe_tracks_loading/entities/loading_tracks_collection/loading_tracks_collection_observer.dart';
import 'package:spotimax/features/domain/tracks/observe_tracks_loading/repository/observe_tracks_loading_repository.dart';
import 'package:spotimax/features/domain/tracks/observe_tracks_loading/repository/observe_tracks_loading_repository_impl.dart';
import 'package:spotimax/features/domain/tracks/observe_tracks_loading/use_cases/get_loading_tracks_collections_observer.dart';
import 'package:spotimax/features/domain/tracks/search_videos_by_track/use_cases/find_10_videos_by_track.dart';
import 'package:spotimax/features/domain/tracks/search_videos_by_track/use_cases/get_video_by_url.dart';
import 'package:spotimax/features/domain/tracks/services/services/download_tracks_service/download_tracks_service.dart';
import 'package:spotimax/features/domain/tracks/services/services/download_tracks_service/download_tracks_service_impl.dart';
import 'package:spotimax/features/domain/tracks/services/use_cases/download_tracks_from_getting_observer.dart';
import 'package:spotimax/features/domain/tracks/services/use_cases/download_tracks_range.dart';
...
import 'package:spotimax/features/domain/tracks/services/use_cases/cancel_track_loading.dart';
import 'package:spotimax/features/domain/tracks/network_tracks/repositories/network_tracks_repository.dart';
...
import 'package:spotimax/features/domain/tracks/services/services/get_tracks_service/get_tracks_service_impl.dart';
import 'package:spotimax/features/domain/tracks/services/use_cases/download_track.dart';
import 'package:spotimax/features/domain/tracks/services/use_cases/get_tracks_with_loading_observer_from_tracks_collection.dart';
import 'package:spotimax/features/domain/tracks/services/use_cases/get_tracks_with_loading_observer_from_tracks_collection_with_offset.dart';
...
import 'package:spotimax/features/domain/tracks_collections/network_tracks_collections/service/network_tracks_collections_service_impl.dart';
...
import 'package:spotimax/features/presentation/change_source_video/bloc/change_source_video_bloc.dart';
import 'package:spotimax/features/presentation/download_tracks_collection/widgets/download_track_info/bloc/download_track_info_bloc.dart';
...
import 'package:spotimax/features/presentation/download_tracks_collection/widgets/track_tile/bloc/track_tile_bloc.dart';
import 'package:spotimax/features/presentation/history/bloc/history_bloc.dart';
import 'package:spotimax/features/presentation/download_tracks_collection/blocs/filter_tracks/filter_tracks_bloc.dart';
import 'package:spotimax/features/presentation/download_tracks_collection/blocs/get_and_download_tracks/get_and_download_tracks_bloc.dart';
import 'package:spotimax/features/presentation/download_tracks_collection/blocs/get_tracks_collection/get_tracks_collection_by_history_bloc.dart';
import 'package:spotimax/features/presentation/download_tracks_collection/blocs/get_tracks_collection/get_tracks_collection_by_url_bloc.dart';
import 'package:spotimax/features/presentation/home/widgets/loading_tracks_collections_list/bloc/loading_tracks_collections_list_bloc.dart';
import 'package:spotimax/features/presentation/home/widgets/loading_tracks_collections_list/widgets/loading_tracks_collection_tile/cubit/loading_tracks_collection_tile_cubit.dart';
import 'package:spotimax/features/presentation/settings/widgets/auth_settings/blocs/account_auth/account_auth_bloc.dart';
import 'package:spotimax/features/presentation/settings/widgets/auth_settings/blocs/client_auth/client_auth_bloc.dart';
import 'package:spotimax/features/presentation/settings/widgets/download_tracks_settings/bloc/download_tracks_settings_bloc.dart';
import 'package:spotimax/features/presentation/settings/widgets/language_setting/bloc/language_setting_bloc.dart';
import 'package:spotimax/features/presentation/tracks_collections_loading_notifications/bloc/tracks_collections_loading_notifications_bloc.dart';
